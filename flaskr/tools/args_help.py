...
parser.add_argument('-f', '--file_path', type=str, default=file_path, help="File path to encrypt or decyrpt")
parser.add_argument('-k', '--key_path', type=str, default=key_path, help="File path to save the key or read the key")
