...
# create black circle on white background for high pass filter call radius = 13
# antialias GaussianBlur mask via blurring call blur = 47

# read input and convert to grayscale
img = cv2.imread('flaskr/tools/cv_2/holimorfic.png', cv2.IMREAD_GRAYSCALE)
hh, ww = img.shape[:2]
