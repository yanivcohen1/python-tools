...
def get_current_weather(location: str) -> dict:
    ...
    Replace the stub with real API integration as needed.
    """
    # Stubbed response
    return {"location": location, "temperature": "22°C", "condition": "Partly Cloudy"}
...
initial_response = ollama.chat(
    ...
    tools=[get_current_weather, calculate],  # pass actual Python functions
)
