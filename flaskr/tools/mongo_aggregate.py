...
pipeline = [
    ...
    {"$match": {"$and": [{"addressesList.city": "Los Angeles"}, {"name": "David"}]}},
    {
        "$project": {
...
enrollments_docs_list: list[EnrollmentResult] = [
    EnrollmentResult(**doc) for doc in enrollments.aggregate(pipeline)
]
