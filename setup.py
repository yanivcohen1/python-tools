...
setup(
    ...
    install_requires=["flask==1.1.2", "marshmallow-dataclass==8.4.1", "marshmallow-enum==1.5.1", "flask-jsonpify==1.5.0",
      ...
      "flask-socketio==5.0.1", "schedule==1.1.0", "Jinja2==2.11.3", "markupsafe==1.1.1", "werkzeug==1.0.1", "pynput",
      ...
      "yfinance", "openai", "igraph", "wget", "marshmallow_sqlalchemy==1.0.0", "manim", "pyhid-usb-relay"
